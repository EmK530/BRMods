...
echo func _process(delta):root.content_scale_factor=root.get_size()[1]/540;root.content_scale_mode=1;root.content_scale_factor=1 >> "%temp%\BuckshotNativeRes.gd"
:skip
